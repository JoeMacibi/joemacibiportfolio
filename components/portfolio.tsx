...
const projects: Project[] = [
  { name: 'InfraRecord', tech: 'TypeScript · Kafka · AI optimization', architecture: 'Infrastructure observability and governance platform for hybrid cloud environments.', problem: 'Creates audit trails, ingests live metrics, and surfaces AI-driven resource optimization.', fallback: 'Cloud observability', repoName: 'InfraRecord' },
  { name: 'Chess3D', repoName: 'chess3D', tech: 'TypeScript · Three.js · Webpack', architecture: 'Interactive browser chess game with custom Blender models and a Web Worker game AI.', problem: 'Brings a responsive 3D chess experience to the browser without blocking the main thread.', fallback: '3D chess game' },
  { name: 'NyumbaSmart', repoName: 'NyumbaSmart', tech: 'AI · M-Pesa · Property operations', architecture: 'AI-powered apartment and facility management platform for African real estate operations.', problem: 'Unifies tenant portals, rent payments, maintenance automation, analytics, and AI insights.', fallback: 'Property management' },
  { name: 'Beckwam stores', repoName: 'Beckwam-stores', tech: 'PHP · POS · Inventory management', architecture: 'Point-of-sale and inventory management system for store operations.', problem: 'Keeps sales and stock workflows organized in one practical retail system.', fallback: 'Retail operations' },
  { name: 'car-rental-project', repoName: 'car-rental-project', tech: 'PHP · MySQL · Admin dashboard', architecture: 'Car-rental application with separate customer and administrator interfaces.', problem: 'Lets customers reserve vehicles while admins manage reservations and fleet operations.', fallback: 'Vehicle reservations' },
  { name: 'saas-landing-page-design', repoName: 'saas-landing-page-design', tech: 'Next.js 16 · React 19 · Tailwind CSS', architecture: 'v0-built SaaS landing page in a modern Next.js App Router project.', problem: 'Provides a polished, deployable marketing surface for a SaaS product.', fallback: 'SaaS marketing page' },
